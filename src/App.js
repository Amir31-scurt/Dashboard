        ...
        <div className="documo pt-7">
          ...
          <div className='w-5/12 ms-8 my-8 flex moto'>
            ...
            <div className="flex items-center w-3/4 mt-3">
              <div className="imge">
                <img src="Images/ellipse1.jpg" className="rounded-full" alt="" />
              </div>
              <div className="ms-5 moto2">
                <h2 className="text-2xl font-bold mb-3 ms-4">Blaze | Service Main</h2>
                <p className="text-sm ms-4 text-gray-500 fonto">Created: 24/02/2019</p>
              </div>
            </div>

            <div className=' mb-4 ms-4 flex items-center justify-center moto3'>
              <button className="rounded-full bg-red-700 text-white p-1"><HiXMark /></button>
          ...
          <div className='ms-8 h-32 w-11/12 shad flex items-center'>
            ...
            <div className="mx-8">
              ...
              <p className='text-sm fonto'>
                ...
                different from what is on file with your carrier in their Customer Service Record (CSR). A CSR is a copy of 
                how your telephone records appear in the telephone company's database.
              </p>
            </div>
          </div>
